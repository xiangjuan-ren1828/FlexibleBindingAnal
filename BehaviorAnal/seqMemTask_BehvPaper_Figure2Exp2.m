...
if isequal(expId, 'interleaved')
    subjList_young = {'4QY3RL', '2023-08-30_17h17.39.428'; ...
    ...
    subjList_old = {'YM1W4L', '2023-05-23_15h56.51.831'; ...
...
save([FBdata_folder, 'Fig2D_FA_lure_overall_YAOA_stats_Exp2.mat'], 'FA_lure_overall_YAOA');
...
save([FBdata_folder, 'Fig2E_transAcc_overall_group_stats_Exp2.mat'], 'transAcc_overall_group');
...
%% ------save the above data for subsequent statistical tests------
save([FBdata_folder, 'Fig2G_binds_overall_group_stats_Exp2.mat'], 'binds_overall_group');
save([FBdata_folder, 'Fig2HI_binds_overall_diff_group_stats_Exp2.mat'], 'binds_overall_diff_group');
